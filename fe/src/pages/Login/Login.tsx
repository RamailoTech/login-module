...
//                         Welcome back
//                     </h1>
//                     <p className="text-[#969696] mt-3">Login to continue</p>

//                     <button className="my-4 w-full flex gap-4 items-center justify-center rounded-lg border border-gray-border hover:bg-gray-100 bg-white py-3 px-3 shadow-sm md:w-4/5" onClick={signInWithGoogle}>
